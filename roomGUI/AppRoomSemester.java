...
public class AppRoomSemester extends JPanel {
	 ...
	 * Create the panel.
	 */
	public AppRoomSemester(MainFrame2 f, boolean availPath) {
		frame = f;
		...
		confirmButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (roomCombo.getSelectedItem() != null && semesterCombo.getSelectedItem() != null) {
					frame.showAppRequestPanel(semesterCombo.getSelectedItem().toString(),
